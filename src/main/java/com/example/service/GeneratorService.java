...
public class GeneratorService {
    ...
    /*
    HNRAVAH432QUBFOD3AW2NM2T3MGWRNOP
     */
    public String getSecretKey() {
        return secretKey;
    }

    /*We only need to use this method once to generate the above key.
      The key then gets registered with google authenticator, so...
     */
